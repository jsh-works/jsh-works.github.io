$(function(){
    ...
    $(".gnb-sub-dep ul li").on('click', function() {
      ...
      } else if($(this).data('info') === 'scribe') {
        $(".gnb-mini-sub-dep.useInfo-tab").hide();
        
      } else if($(this).data('info') === 'use') {
