$(function(){
    ...
    new Swiper ('.gnb-mini-sub-dep.mngt-tab', {
      loop: false,
      speed: 500,
      pagination: false,
      slidesPerView: 'auto',
    ...
    $('.gnb-mini-sub-dep.mngt-tab .swiper-slide').on('click', function () {
        var scrIdx = $(this).index();
        var scrSwiper = $('.gnb-mini-sub-dep.mngt-tab')[0].swiper;
    ...
    $(".gnb-sub-dep ul li").on('click', function() {
      if($(this).data('tab') == '1') {
        $(".gnb-mini-sub-dep.mngt-tab").show();
